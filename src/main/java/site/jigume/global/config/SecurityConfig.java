package site.jigume.global.config;
...
import site.jigume.global.jwt.JwtAuthenticationEntryPoint;
import site.jigume.global.jwt.JwtAuthenticationProcessingFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .requestMatchers(new AntPathRequestMatcher(("/api/member/nickname"))).permitAll()
